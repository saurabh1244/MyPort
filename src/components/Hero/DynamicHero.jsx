  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto space-y-8">
        ...
        <div className="relative inline-block">
          <GlitchText 
            ...
            className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-500 bg-clip-text text-transparent"
          />
      ...
      <button
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce text-gray-400 hover:text-yellow-400 transition-colors z-20"
      >
